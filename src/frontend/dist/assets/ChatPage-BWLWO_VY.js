...
import { n as Subscribable, p as pendingThenable, o as resolveEnabled, s as shallowEqualObjects, q as resolveStaleTime, t as noop$3, v as environmentManager, w as isValidTimeout, x as timeUntilStale, y as timeoutManager, z as focusManager, B as fetchState, C as replaceData, D as notifyManager, r as reactExports, E as shouldThrowError, F as useQueryClient, f as createLucideIcon, i as useUIStore, j as jsxRuntimeExports, U as Users, m as motion, g as cn, h as mockGroups, G as useComposedRefs, H as useCallbackRef, I as useLayoutEffect2, J as commonjsGlobal, K as getDefaultExportFromCjs, L as clsx, R as React, M as invariant, N as useParams, u as useAuthStore, A as AnimatePresence, P as Plus, O as Skeleton, b as ue } from "./index-CojF2jFo.js";
import { H as Hash$2 } from "./hash--rUsAWO2.js";
import { u as useMutation, T as TaskDetailModal, A as AddTaskModal, s as sendMessage, g as getMessages, a as getTasks } from "./TaskDetailModal-DYYZBihw.js";
import { B as Button } from "./button-DxNoqw_w.js";
import { P as Primitive, a as Presence, c as createContextScope, b as composeEventHandlers } from "./index-nBNohzx_.js";
...
const ChartNoAxesColumn = createLucideIcon("chart-no-axes-column", __iconNode$8);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const PanelRight = createLucideIcon("panel-right", __iconNode$2);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function findGroup(id, groups) {
  for (const g2 of groups) {
    if (g2.id === id) return g2;
    if (g2.children) {
      const found = findGroup(id, g2.children);
...
function TopBar() {
  const { activeGroupId, rightPanelOpen, toggleRightPanel, toggleSidebar } = useUIStore();
  const group = activeGroupId ? findGroup(activeGroupId, mockGroups) : null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-14 px-4 border-b border-border bg-card shadow-xs flex-shrink-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
      ...
      group ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Hash$2, { className: "w-4 h-4 text-muted-foreground flex-shrink-0" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-sm text-foreground truncate", children: group.name }),
      ...
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-sm text-foreground", children: "Select a channel" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.button,
        {
          ...
          className: cn(
            ...
            rightPanelOpen ? "bg-muted text-foreground" : "text-muted-foreground hover:text-foreground hover:bg-muted"
          ),
          title: "Toggle tasks panel",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(PanelRight, { className: "w-4 h-4" })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
...
function MessageSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 px-4 py-2", children: [
...
function TaskSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-4 space-y-2.5", children: [
...
function StatusBadge({ status }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "span",
    {
      ...
      children: [
        status === "pending" && /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-2.5 h-2.5" }),
        status === "in_progress" && /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-2.5 h-2.5" }),
        status === "completed" && /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCheck, { className: "w-2.5 h-2.5" }),
        label
      ]
    }
  );
...
function TabBar({
  ...
  const tabs = [
    ...
    },
    {
      id: "tasks",
      label: "Tasks",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SquareCheck, { className: "w-3.5 h-3.5" })
    },
    {
      id: "reports",
      label: "Reports",
...
function ChatTab({ groupId }) {
  ...
  const sendMut = useMutation({
    mutationFn: (content) => sendMessage(groupId, content, (user == null ? void 0 : user.id) ?? "", (user == null ? void 0 : user.name) ?? ""),
    onMutate: (content) => {
      const optimistic = {
        id: `opt-${Date.now()}`,
        groupId,
        senderId: (user == null ? void 0 : user.id) ?? "",
        senderName: (user == null ? void 0 : user.name) ?? "",
        content,
    ...
    onSuccess: (newMsg, _vars, ctx) => {
      queryClient.setQueryData(
        ["messages", groupId],
        (old) => (old ?? []).map((m2) => m2.id === (ctx == null ? void 0 : ctx.optimistic.id) ? newMsg : m2)
      );
    ...
    onError: (_err, _vars, ctx) => {
      queryClient.setQueryData(
        ["messages", groupId],
        (old) => (old ?? []).filter((m2) => m2.id !== (ctx == null ? void 0 : ctx.optimistic.id))
      );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1 min-h-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 pb-2 space-y-0.5", children: [
      isLoading ? MSG_SKELETON_KEYS.map((k2) => /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSkeleton, {}, k2)) : messages.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "flex flex-col items-center justify-center py-16 text-center",
          "data-ocid": "chat.messages_empty_state",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { className: "w-10 h-10 text-muted-foreground mb-3" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "No messages yet" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Be the first to say something!" })
          ]
        }
      ) : messages.map((msg, i) => {
        const isMe = msg.senderId === (user == null ? void 0 : user.id);
        const showHeader = i === 0 || messages[i - 1].senderId !== msg.senderId;
        const initials = msg.senderName.split(" ").map((n2) => n2[0]).slice(0, 2).join("");
        if (isMe) {
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                showHeader && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-2 mb-1 mr-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: msg.timestamp }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground", children: "You" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[75%] bg-foreground text-background rounded-2xl rounded-tr-sm px-4 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm leading-relaxed break-words", children: msg.content }) })
              ]
            },
            msg.id
          );
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            "data-ocid": `chat.message.${i + 1}`,
            children: [
              showHeader && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-foreground flex items-center justify-center flex-shrink-0 text-xs font-bold text-background", children: initials }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("flex-1 min-w-0", !showHeader && "ml-0"), children: [
                showHeader && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-2 mb-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground", children: msg.senderName }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: msg.timestamp })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block max-w-[75%] bg-muted/60 text-foreground rounded-2xl rounded-tl-sm px-4 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm leading-relaxed break-words", children: msg.content }) })
              ] })
            ]
          },
          msg.id
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-3 border-t border-border bg-card flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 bg-background rounded-2xl border border-border px-4 py-2.5 focus-within:border-foreground/40 transition-smooth shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          ...
          value: messageText,
          onChange: (e3) => setMessageText(e3.target.value),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.button,
        {
          ...
          children: sendMut.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { className: "w-4 h-4" })
        }
      )
    ] }) })
  ] });
...
function TasksTab({
  ...
  const filtered = tasks.filter(
    (t2) => filter === "all" ? true : t2.status === filter
  );
  const handleTaskUpdate = (updated) => {
    queryClient.setQueryData(
      ["tasks", groupId],
      (old) => (old ?? []).map((t2) => t2.id === updated.id ? updated : t2)
    );
    setSelectedTask(updated);
  };
  const handleTaskCreate = (task) => {
    queryClient.setQueryData(["tasks", groupId], (old) => [
      ...old ?? [],
      task
    ]);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1 min-h-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: filterTabs.map((ft) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            ...
            className: cn(
              ...
              filter === ft.id ? "bg-foreground text-background border-foreground" : "bg-transparent text-muted-foreground border-border hover:border-foreground/40 hover:text-foreground"
            ),
            children: ft.label
          },
          ft.id
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 space-y-3", children: isLoading ? TASK_SKELETON_KEYS.map((k2) => /* @__PURE__ */ jsxRuntimeExports.jsx(TaskSkeleton, {}, k2)) : filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "flex flex-col items-center justify-center py-16 text-center",
        "data-ocid": "chat.tasks_empty_state",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SquareCheck, { className: "w-10 h-10 text-muted-foreground mb-3" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "No tasks" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: filter === "all" ? "Create a task to get started" : `No ${filter.replace("_", " ")} tasks` })
        ]
      }
      ...
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: task.assignedToName }),
    ...
    canManage && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 border-t border-border bg-card flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
      {
        type: "button",
        variant: "outline",
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: ["r1", "r2", "r3", "r4"].map((k2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-20 rounded-2xl" }, k2)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-48 rounded-2xl" })
        ]
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-5", "data-ocid": "chat.reports_panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: [
      ...
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-display font-bold text-foreground", children: stat.value }),
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground", children: "Completion" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground mb-4", children: "Tasks by Status" }),
    ...
    userBreakdown.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "bg-card rounded-2xl border border-border p-5 space-y-3",
        "data-ocid": "chat.reports.user_breakdown",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground", children: "By Assignee" }),
          userBreakdown.map((u2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-full bg-foreground flex items-center justify-center text-xs font-bold text-background flex-shrink-0", children: u2.name.charAt(0) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-foreground truncate", children: u2.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground flex-shrink-0 ml-2", children: [
                  u2.count,
                  " task",
                  u2.count !== 1 ? "s" : ""
                ] })
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-1.5 bg-muted rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
                  initial: { width: 0 },
                  animate: {
                    width: total > 0 ? `${u2.count / total * 100}%` : "0%"
                  },
...
function ChatPage() {
  ...
  const canManage = (user == null ? void 0 : user.role) === "owner" || (user == null ? void 0 : user.role) === "admin" || (user == null ? void 0 : user.role) === "manager";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full bg-background", "data-ocid": "chat.page", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(TabBar, { active: activeTab, onChange: setActiveTab }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          activeTab === "chat" && /* @__PURE__ */ jsxRuntimeExports.jsx(ChatTab, { groupId }),
          activeTab === "tasks" && /* @__PURE__ */ jsxRuntimeExports.jsx(TasksTab, { groupId, canManage }),
          activeTab === "reports" && /* @__PURE__ */ jsxRuntimeExports.jsx(ReportsTab, { groupId })
        ]
      },
      activeTab
    ) })
