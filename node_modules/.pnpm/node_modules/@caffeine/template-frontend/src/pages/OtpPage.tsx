...
import { mockCompany, mockCurrentUser } from "@/lib/mock-data";
...
export function OtpPage() {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: startTimer is stable (uses only refs/setters)
  useEffect(() => {
    startTimer();
